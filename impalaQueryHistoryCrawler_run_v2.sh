...
spark2-submit  --queue root.impala --conf spark.network.timeout=800 --driver-memory 2g --executor-memory 2g  --master yarn  --deploy-mode client  impalaQueryHistoryCrawler_v2.py
